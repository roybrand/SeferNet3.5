...
IF(@EmployeeSector_cond <> '-1')
	SET @SqlWhere = @SqlWhere + 
	' AND ( Employee.IsMedicalTeam = 1 OR Employee.EmployeeSectorCode = @xEmployeeSector_cond
	) '	
if(@adminClinic = '1' )
	begin 
