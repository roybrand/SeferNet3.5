IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'rpc_getReportDeptsByTypesProfessionsDynamic')
	BEGIN
		DROP  Procedure  rpc_getReportDeptsByTypesProfessionsDynamic
	END

GO

create Procedure [dbo].[rpc_getReportDeptsByTypesProfessionsDynamic]
(
...
set @sqlWhere = 'WHERE ';
---------------------------
DECLARE @SortedByDefault varchar(500)
