...
הדוח יכלול נותני שירות פעילים מסקטור רופאים, ביחידות קהילה מסוג:
...
קובץ שנוצר הוא : EmployeeReceptionForMobile.xls
...
and xde.AgreementType in (select AgreementTypeID from DIC_AgreementTypes where OrganizationSectorID = 1)
