...
public partial class SeferMasterPage : System.Web.UI.MasterPage, ICallbackEventHandler
{
    ...
    private void SetControlsByUserLoginState()
    {
        ...
        if (loggedInUser == null)
        {
            ...
            lblLogin.Text = "Login";
            lblLogin.Attributes.Add("OnClick", "ShowLoginPopUp()");
        }
        else
        {
