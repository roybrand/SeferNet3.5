<%@ Page Title=" " Language="C#" MasterPageFile="~/SeferMasterPageIEwide.master" AutoEventWireup="true"
    UICulture="he-il" Culture="he-il" Inherits="Admin_AddRemark"
    ValidateRequest="false" Codebehind="AddRemark.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="pageContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript" defer="defer">
        ...
        function CloseItselfAsModalWindow() {
            ...
            var remarkElement = document.getElementById("<%=txtFormatedRemark.ClientID %>");

            var remark = remarkElement.value;
            ...
            parent.validateTime(null, remarkElement);
...
<%--        function InitialRemarkControlsSettings() {
            var divRemark = $("#divRemarks");
            var divRemarksRTF = document.getElementById('<%= divRemarksRTF.ClientID %>');

            var txtRemarkIsOfReachTextFormat  = document.getElementById('<%= txtRemarkIsOfReachTextFormat.ClientID %>');

            divRemark.show();
            divRemarksRTF.style.height = "5px";
            txtRemarkIsOfReachTextFormat.value = "";
        }--%>
