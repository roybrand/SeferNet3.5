...
public partial class SeferMasterPageIEwide : System.Web.UI.MasterPage, ICallbackEventHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["isModalWindow"] != null && Session["isModalWindow"].ToString() == "1")
        {
            divMenu.Style.Add("display", "none");
            Session["isModalWindow"] = null;
        }
    }
