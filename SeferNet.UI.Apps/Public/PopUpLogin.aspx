<%@ Page Language="C#" AutoEventWireup="true" Inherits="PopUpLogin" Codebehind="PopUpLogin.aspx.cs" %>
         ...
         <tr>
             <td style="padding-top:10px; padding-left:10px;">
                <table style="width:100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td id="BorderLeft" style="background-image: url('../Images/Applic/borderGreyV.jpg'); background-repeat: repeat-y; background-position: left">
                        </td>
                        <td align="center" style="padding-top:15px">
                             <table width="280px" dir="rtl">                   
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList Width="150px" ID="ddlUserDomain" runat="server" DataTextField="DomainName" DataValueField="DomainName"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="vertical-align:bottom; background-image:url(../Images/Applic/regButtonBG_Middle.gif); background-repeat:repeat-x; background-position:bottom;">
                                                    <asp:Button id="btnCancel" Width="40px" CssClass="RegularUpdateButton" runat="server" OnClientClick="self.close(); return false" Text="ביטול"></asp:Button>
                                                </td>
                                                <td style="background-position:right bottom; background-image:url(../Images/Applic/regButtonBG_Left.gif); background-repeat:no-repeat;">&nbsp;
                                                </td>
                                            </tr>
                        ...
                        <td id="BorderRight" style="background-image: url('../Images/Applic/borderGreyV.jpg'); background-repeat: repeat-y; background-position: right">
                        </td>
                    </tr>
                    <tr>
